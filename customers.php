                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <button type="button" onclick="location.href = 'add_customers.php';"
                                    class="btn btn-primary float-right"><i class='fas fa-plus-circle'></i> Add Customer
                            </button>
                            <h3 class="card-title">All customers information</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . $row['customer_cell'] . "</td>";
                                    echo "<td>" . $row['customer_address'] . "</td>";

                                    if ($user_type == 'admin') {

                                        echo "<td><a class='btn btn-primary'  href=\"edit_customer.php?id=" . $row['customer_id'] . "\" ><i class='fas fa-edit'></i></a>  ";
                                        echo "<a class='confirmation btn btn-danger'  href=\"delete_customer.php?id=" . $row['customer_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
