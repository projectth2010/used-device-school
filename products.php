                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    if ($user_type=='admin') {
                                        ...
                                        echo "<a style='margin: 2px' class='btn btn-primary'  href=\"edit_product.php?id=" . $row['product_id'] . "\" ><i class='fas fa-edit'></i></a>  ";
                                        echo "<a style='margin:2px' class='confirmation btn btn-danger'  href=\"delete_product.php?id=" . $row['product_id'] . "\" ><i class='fas fa-trash'></i></a></td>";
                                    }
